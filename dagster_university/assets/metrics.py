...
def trips_by_week(context, database: DuckDBResource):
    ...
    query = f"""
        ...
        from trips
        where
            pickup_datetime >= '{period_to_fetch}' AND
            pickup_datetime < '{period_to_fetch}'::date + interval '7 days'
    """
