...
from .schedules import trip_update_schedule, trip_by_week_update_schedule
from .sensors import adhoc_request_sensor

trip_assets = load_assets_from_modules([trips])
metric_assets = load_assets_from_modules([metrics])
request_assets = load_assets_from_modules([requests])
all_jobs = [trip_update_job, trip_by_week_update_job]
all_schedules = [trip_update_schedule, trip_by_week_update_schedule]
